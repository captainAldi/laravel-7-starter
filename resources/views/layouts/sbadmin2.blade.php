  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion sidebar-sticky" id="accordionSidebar">
      ...
      <li class="nav-item {{ (request()->is('/page')) ? 'active' : '' }}">
        ...
        <div id="collapsePages" class="collapse {{ (request()->is('/page')) ? 'show' : '' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            @else
              <li class="nav-item">
                <a class="btn bg-info mt-3 text-white" href="{{ route('login') }}" aria-haspopup="true" aria-expanded="false">
                  Login 
                </a>
                <a class="btn bg-info mt-3 text-white" href="{{ route('register') }}" aria-haspopup="true" aria-expanded="false">
                  Register 
                </a>
              </li>
            @endauth
